    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.timezone.now, help_text='date de début du conseil', verbose_name='date de début du conseil')),
                ('end_date', models.DateField(default=datetime.datetime(2020, 1, 5, 19, 43, 57, 272437, tzinfo=utc), help_text='date de fin du conseil.', verbose_name='date de fin du conseil')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.timezone.now, help_text='date de début du contrat', verbose_name='date de début du contrat')),
                ('end_date', models.DateField(default=datetime.datetime(2020, 1, 5, 19, 43, 57, 271161, tzinfo=utc), help_text='date de fin du contrat.', verbose_name='date de fin du contrat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=django.utils.timezone.now, help_text='date de la facture.', verbose_name='date de la facture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actual_date', models.DateField(default=django.utils.timezone.now, help_text='fin du service (ACTUEL)(en mois/jours).', verbose_name='fin du service (ACTUEL ???)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.timezone.now, help_text='date de début (en mois/jours).', verbose_name='date de début')),
                ('end_date', models.DateField(default=datetime.datetime(2020, 1, 5, 19, 43, 57, 273352, tzinfo=utc), help_text='durée de la license (en mois/jours).', verbose_name='durée de la license')),
                ...
                ('invoice', models.ForeignKey(default=None, help_text='la facture relative à cette license.', null=True, on_delete=django.db.models.deletion.CASCADE, to='mvp.Invoice', verbose_name='la facture relative à cette license')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='conseil',
            name='invoice',
            field=models.ForeignKey(default=None, help_text='la facture relative à ce conseil.', null=True, on_delete=django.db.models.deletion.CASCADE, to='mvp.Invoice', verbose_name='la facture relative à ce conseil'),
        ),
        migrations.AddField(
