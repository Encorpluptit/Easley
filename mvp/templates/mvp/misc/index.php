...
<head>
	...
	<!-- STYLE CSS -->
	<link rel="stylesheet" type="text/css" href= {% static 'mvp/Home/style.css' %}>

        <!-- ICONE TAB -->
	<link rel="icon" type="text/css" href={% static 'mvp/Home/images/icone-easly-dark-transparent-background.png' %}>
...
<body>
    ...
    <main class="content">
		<header id="header">
			<img id="logo-header" src= {% static 'mvp/Home/images/logo-easly-dark-horizontal.png' %}>
		</header>
		...
		<div id="inscription-container">
			<div id="illustration-container">
				<div id="illustration-box">
					<img id="sky" src= {% static 'mvp/Home/images/background.png' %} >
					<img id="fusée" src= {% static 'mvp/Home/images/rocket-147466_1280.png' %}>
					<img id="fire" src= {% static 'mvp/Home/images/fire.png' %}>
					<img class="star" id="star1" src= {% static 'mvp/Home/images/star.png' %}>
				</div>
			</div>
			<div id="inscription-box">
				...
				<?php
					try
					{
						$bdd = new PDO('pgsql:host=ec2-54-75-235-28.eu-west-1.compute.amazonaws.com;port=5432;dbname=d3t7apg13rcq0r;charset=utf8', 'wdingvfhkjxqwq', 'f320d7d066807877b10ef53914c9ba99d9c9ccf65f84f09a661e7b2685986d8d');
					}
					catch(Exception $e)
					{
...
<!-- SCRIPT JS -->
<script type="text/javascript" src= {% static 'mvp/Home/script.js' %}></script>
<!-- SCRIPT JQUERY -->
