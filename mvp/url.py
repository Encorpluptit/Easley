...
urlpatterns = [
    ...
    path('workspace/Contracts/csv/', views.viewContractCsv, name='mvp-contract-csv'),
    path('workspace/Invoices/csv/', views.viewInvoiceCsv, name='mvp-invoice-csv'),
    path('<int:cpny_pk>/facturation/<int:invoice_pk>/validate/', views.doFacturation,
         name="mvp-do-facturation"),
    path('facturation/<int:invoice_pk>/payed/', views.doPayedinvoice, name="mvp-do-payed"),
