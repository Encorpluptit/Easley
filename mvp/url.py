...
urlpatterns = [
    ...
    path('<int:cpny_pk>/contract/new/', views.CreateContract_Client, name='mvp-contract-new'),
    path('<int:cpny_pk>/contract/<int:client_pk>/new/', views.CreateContract_Contract, name='mvp-contract-form'),
